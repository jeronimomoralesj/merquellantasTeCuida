...
// PUT /api/elearning/videos/[id] — update video (admin)
export async function PUT(
  ...
  if (typeof body.video_url === 'string') setDoc.video_url = body.video_url;
...
// DELETE /api/elearning/videos/[id] — delete video (admin)
