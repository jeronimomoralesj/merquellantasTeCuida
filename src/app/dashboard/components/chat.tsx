...
const HELP_TOPICS: HelpTopic[] = [
  {
    ...
    icon: Palmtree,
    walkthrough: [
      "Estás en el módulo de solicitudes. Arriba verás pestañas: Permiso, Vacaciones e Incapacidad.",
      "Selecciona la pestaña \"Permiso\".",
      "Elige la fecha y marca la hora de inicio y fin del permiso que necesitas.",
      "Escribe una breve descripción del motivo en el cuadro de texto.",
      "Haz clic en \"Enviar solicitud\". Talento Humano revisará y recibirás respuesta aquí mismo.",
    ],
  },
  {
    id: "vacaciones",
    ...
    walkthrough: [
      ...
      "Revisa tu saldo de días disponibles — aparece en la tarjeta superior.",
      "Elige la fecha de inicio y la fecha de regreso. El sistema calcula los días automáticamente.",
      "Si tu empresa requiere soporte, adjunta el documento.",
      "Haz clic en \"Enviar solicitud\" y espera la aprobación de tu líder y Talento Humano.",
    ],
  },
  {
    id: "cesantias",
